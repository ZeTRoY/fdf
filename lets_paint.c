...
/*   Updated: 2018/07/28 18:30:01 by aroi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	ft_draw_line(fdf, fdf->currx + coord[j][i].x, fdf->curry + coord[j][i].y,
**	fdf->currx + coord[j][i + 1].x, fdf->curry + coord[j][i + 1].y,
**	MAX(coord[j][i].color, coord[j][i + 1].color));
*/
			ft_draw_line(fdf, br1, create_bresenham(fdf->currx +
	coord[j + 1][i].x, fdf->curry + coord[j + 1][i].y, coord[j + 1][i].color));
/*	ft_draw_line(fdf, fdf->currx + coord[j][i].x, fdf->curry + coord[j][i].y,
**	fdf->currx + coord[j + 1][i].x, fdf->curry + coord[j + 1][i].y,
**	MAX(coord[j][i].color, coord[j + 1][i].color));
*/
		}
